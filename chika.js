...
case 'menu': {
if(typemenu == 'image'){
await chika.send5ButImg(from, `` + '' + lang.menu(botname, pushname, salam), `© ${ownername}`,thumb, [{"urlButton": {"displayText": "YOUTUBE OWNER ☠️️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "OWNER 😱","id": 'owner'}},{"quickReplyButton": {"displayText": "MENU BOT 😤","id": 'command'}}] )
}
if(typemenu == 'gif'){
await chika.send5ButGif(from, `` + '' + lang.menu(botname, pushname, salam), `© ${ownername}`,velochika, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "OWNER 😱","id": 'owner'}},{"quickReplyButton": {"displayText": "LIST MENU BOT 👻","id": 'command'}}] )
}
if(typemenu == 'list'){
await chika.sendListMenu(from, `Selamat ${salam} kak ${pushname}` , lang.list(pushname) , 'CLICK HERE', {quoted: fkontak})
}
...
await chika.send5ButImg(from, `` + '' + lang.allmenu(prefix, pushname, botname, time, salam), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "OWNER 😱","id": 'owner'}}] )
}
if(typemenu == 'gif'){
await chika.send5ButGif(from, `` + '' + lang.allmenu(prefix, pushname, botname, time, salam), `© ${ownername}`,velochika, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "OWNER 😱","id": 'owner'}}] )
}
if(typemenu == 'catalog'){
...
await chika.send5ButImg(from, `` + '' + lang.groupmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'downloadermenu':
var riych = await getBuffer(picak+'Downloader Menu')
await chika.send5ButImg(from, `` + '' + lang.downloadermenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'searchmenu':
var riych = await getBuffer(picak+'Search Menu')
await chika.send5ButImg(from, `` + '' + lang.searchmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'randommenu':
var riych = await getBuffer(picak+'Random Menu')
await chika.send5ButImg(from, `` + '' + lang.randommenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'randomanimemenu':
var riych = await getBuffer(picak+'Random Anime Menu')
await chika.send5ButImg(from, `` + '' + lang.randomanimemenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'searchmenu':
var riych = await getBuffer(picak+'Search Menu')
await chika.send5ButImg(from, `` + '' + lang.searchmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
...
await chika.send5ButImg(from, `` + '' + lang.textpromenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'photooxymenu':
var riych = await getBuffer(picak+'Photo Oxy Menu')
await chika.send5ButImg(from, `` + '' + lang.photooxymenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'ephotomenu':
var riych = await getBuffer(picak+'Ephoto Menu')
await chika.send5ButImg(from, `` + '' + lang.ephotomenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'funmenu':
var riych = await getBuffer(picak+'Fun Menu')
await chika.send5ButImg(from, `` + '' + lang.funmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'primbonmenu':
var riych = await getBuffer(picak+'Primbon Menu')
await chika.send5ButImg(from, `` + '' + lang.primbonmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'convertmenu':
var riych = await getBuffer(picak+'Converter Menu')
await chika.send5ButImg(from, `` + '' + lang.convertmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'mainmenu':
var riych = await getBuffer(picak+'Main Menu')
await chika.send5ButImg(from, `` + '' + lang.mainmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'databasemenu':
...
await chika.send5ButImg(from, `` + '' + lang.anonymousmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'islamicmenu':
var riych = await getBuffer(picak+'Islamic Menu')
await chika.send5ButImg(from, `` + '' + lang.islamicmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'voicechargermenu':
var riych = await getBuffer(picak+'Voice Charger Menu')
await chika.send5ButImg(from, `` + '' + lang.voicechargermenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'ownermenu':
var riych = await getBuffer(picak+'Owner Menu')
await chika.send5ButImg(from, `` + '' + lang.ownermenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "DONASI MONGGO 😁","id": 'donate'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'donasi': case 'donate':
var riych = await getBuffer(picak+'Donasi')
await chika.send5ButImg(from, `` + '' + lang.donasi(ownernomer), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "OWNER 😱","id": 'owner'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
case 'thanksto': case 'tqto':
var riych = await getBuffer(picak+'Contributors')
await chika.send5ButImg(from, `` + '' + lang.thanksto(), `  © ${ownername} | Support By 0@s.whatsapp.net`,riych, [{"urlButton": {"displayText": "GROUP BOT ☠️","url": `${youtube}`}},{"urlButton": {"displayText": `IG OWNER 👽`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "OWNER 😱","id": 'owner'}},{"quickReplyButton": {"displayText": "KEMBALI KE MENU 👤","id": 'command'}}] )
break
             default:
                if (budy.startsWith('=>')) {
                    if (!isCreator) return reply(mess.owner)
